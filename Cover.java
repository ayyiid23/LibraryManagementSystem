...
public class Cover extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Connection DB_con = DriverManager.getConnection("jdbc:mysql://localhost:3306/library", 
            "root","Shistu123");
            Statement Query_stat = DB_con.createStatement();
           // Query_stat.executeUpdate("insert into users values('"+t2.getText()+"','"+t4.getText()+"');");
